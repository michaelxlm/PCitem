...
document.write("<link href=\"./js/sign/libs/css/canvas_css.css\" rel=\"stylesheet\">");
document.write("<link href=\"./js/sign/libs/css/sp.css\" rel=\"stylesheet\">");

document.write("<link media=\"screen and (max-width: 480px)\" href=\"./js/sign/libs/css/mw480Portrait.css\" rel=\"stylesheet\">");
document.write("<link media=\"screen and (min-width: 480px) and (max-width: 1024px)\" href=\"./js/sign/libs/css/mw480Portrait.css\" rel=\"stylesheet\">");
document.write("<link media=\"screen and (min-width: 1024px)\" href=\"./js/sign/libs/css/sw1024.css\" rel=\"stylesheet\">");

document.write("<script language=javascript src=\"./js/sign/libs/zlib/deflate.min.js\" charset=\"utf-8\" type=\"text/javascript\" ></script>");

document.write("<script language=javascript src=\"./js/sign/libs/CryptoJS v3.1.2/components/core-min.js\" charset=\"utf-8\" type=\"text/javascript\" ></script>");
document.write("<script language=javascript src=\"./js/sign/libs/CryptoJS v3.1.2/rollups/sha1.js\" charset=\"utf-8\" type=\"text/javascript\" ></script>");
document.write("<script language=javascript src=\"./js/sign/libs/CryptoJS v3.1.2/rollups/tripledes.js\" charset=\"utf-8\" type=\"text/javascript\" ></script>");
document.write("<script language=javascript src=\"./js/sign/libs/CryptoJS v3.1.2/components/mode-ecb.js\" charset=\"utf-8\" type=\"text/javascript\" ></script>");

document.write("<script language=javascript src=\"./js/sign/libs/anysignCommentUI.js\" charset=\"utf-8\" type=\"text/javascript\" ></script>");
/*document.write("<script language=javascript src=\"./js/sign/libs/anysign_all.js\"  type=\"text/javascript\" charset=\"utf-8\"></script>");*/
